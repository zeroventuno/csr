...
--  Crea le tabelle, abilita la RLS (l'app usa la service role che la
--  bypassa) e inserisce i contenuti di esempio.
-- ============================================================
...
-- ---------- STORAGE ----------
-- Bucket pubblico per i file caricati dalla Media Library.
...
-- ---------- NEWS ----------
insert into public.news (slug, title, category, location_id, excerpt, content, icon, author, published, date) values
  (
    'campionati-regionali-estivi-podio',
    $$Campionati Regionali Estivi: il Roero sale sul podio$$,
    'Eventi', 'cuneo',
    $$I nostri atleti conquistano 14 medaglie ai Regionali di categoria. Un weekend memorabile che premia mesi di lavoro in vasca.$$,
...
<p>Archiviata la stagione estiva, il gruppo agonistico è già al lavoro per la preparazione invernale. Le iscrizioni ai corsi e alle selezioni per la squadra agonistica sono aperte in tutte le sedi.</p>$html$,
  ...
  (
    'chiusura-estiva-piscina-alba',
    $$Chiusura estiva della piscina di Alba$$,
    'Avvisi', 'alba',
    $$La vasca resterà chiusa dal 4 al 18 agosto per manutenzione programmata.$$,
  ...
  (
    'iscrizioni-corsi-autunnali',
    $$Aperte le iscrizioni ai corsi autunnali$$,
    'Corsi', 'all',
    $$Prenota ora: i gruppi si completano rapidamente in tutte le sedi.$$,
  ...
  (
    'open-day-acquaticita-savigliano',
    $$Open Day acquaticità per i più piccoli$$,
    'Eventi', 'savigliano',
    $$Sabato 5 luglio prova gratuita di mininuoto e babynuoto.$$,
  ...
  (
    'nuovi-orari-nuoto-libero-asti',
    $$Nuovi orari di nuoto libero ad Asti$$,
    'Comunicati', 'asti',
    $$Da luglio fasce serali estese fino alle 22:30 nei giorni feriali.$$,
  ...
  (
    'vacanza-sportiva-2026-programma',
    $$Vacanza Sportiva 2026: programma estivo$$,
    'Corsi', 'cuneo',
    $$Centri estivi tra nuoto, giochi d'acqua e attività all'aperto per 6–14 anni.$$,
  ...
  (
    'giornata-benessere-acqua',
    $$Giornata del benessere in acqua$$,
    'Eventi', 'sommariva',
    $$Sessioni gratuite di acquagym dolce dedicate agli over 60.$$,
  ...
  (
    ...
    'Avvisi', 'savigliano',
    $$Possibili variazioni della temperatura vasca nella settimana.$$,
  ...
  (
    'affiliazione-fin-2026-27',
    $$Affiliazione confermata con la FIN per il 2026/27$$,
    'Comunicati', 'all',
    $$Il Centro rinnova la collaborazione con la Federazione Italiana Nuoto.$$,
...
-- ---------- COURSES ----------
insert into public.courses (category_id, name, age, schedule, price, price_note, instructor, location_id) values
  ('babynuoto', $$Piccoli Pesci$$, '3-36 mesi', $$Sab 10:00–10:45$$, '€75', $$/mese · 4 lezioni$$, 'Giulia Berra', 'cuneo'),
  ('babynuoto', $$Acquaticità 0-1$$, '3-36 mesi', $$Mer 16:30–17:15$$, '€75', $$/mese · 4 lezioni$$, 'Marco Olivero', 'alba'),
  ('mininuoto', $$Mini A (3-4 anni)$$, '3-4 anni', 'Lun/Gio 17:00', '€68', $$/mese · 8 lezioni$$, 'Sara Ferrero', 'alba'),
  ('mininuoto', $$Mini B (4-5 anni)$$, '4-5 anni', 'Mar/Ven 17:00', '€68', $$/mese · 8 lezioni$$, 'Sara Ferrero', 'savigliano'),
  ('nuoto-bambini', $$Principianti$$, '6-13 anni', 'Lun/Mer 17:30', '€62', $$/mese · 8 lezioni$$, 'Luca Demaria', 'cuneo'),
  ('nuoto-bambini', $$Avanzati$$, '6-13 anni', 'Mar/Gio 18:30', '€62', $$/mese · 8 lezioni$$, 'Luca Demaria', 'cuneo'),
  ('nuoto-bambini', $$Perfezionamento$$, '6-13 anni', 'Ven 18:00 + Sab 11:00', '€70', $$/mese · 8 lezioni$$, 'Elena Bosio', 'asti'),
  ('nuoto-adulti', $$Base$$, '14+', 'Lun/Mer 20:00', '€58', $$/mese · 8 lezioni$$, 'Andrea Rossi', 'savigliano'),
  ('nuoto-adulti', $$Intermedio$$, '14+', 'Mar/Gio 19:00', '€58', $$/mese · 8 lezioni$$, 'Andrea Rossi', 'cuneo'),
  ('acquagym', $$Acquagym Tonic$$, 'Adulti', 'Lun/Mer 19:30', '€55', $$/mese · 8 lezioni$$, 'Chiara Viglietti', 'asti'),
  ('acquagym', $$Acquagym Soft 60+$$, 'Adulti', 'Mar/Gio 10:30', '€50', $$/mese · 8 lezioni$$, 'Chiara Viglietti', 'sommariva'),
  ('agonistica', $$Esordienti$$, 'Su selezione', '3x settimana', '€95', '/mese', 'D.T. Paolo Conti', 'cuneo'),
  ('agonistica', $$Ragazzi/Juniores$$, 'Su selezione', '5x settimana', '€120', '/mese', 'D.T. Paolo Conti', 'cuneo'),
  ('speciali', $$Nuoto Inclusivo$$, 'Tutte le età', $$Sab 15:00–16:00$$, 'Su richiesta', 'convenzioni ASL', 'Staff dedicato', 'cuneo'),
  ('speciali', $$Riabilitazione in acqua$$, 'Tutte le età', 'Su appuntamento', 'Su richiesta', 'individuale', 'Fisioterapista', 'alba'),
  ('vacanza', $$Settimana Full$$, '6-14 anni', $$Lun–Ven 8:00–17:00$$, '€140', '/settimana', 'Staff estivo', 'cuneo'),
  ('vacanza', $$Settimana Mattino$$, '6-14 anni', $$Lun–Ven 8:00–13:00$$, '€95', '/settimana', 'Staff estivo', 'savigliano');

-- ---------- EVENTS ----------
insert into public.events (title, date, time, location_id, description) values
  ($$Open Day acquaticità$$, '2026-07-05', '10:00', 'savigliano', $$Prova gratuita di mininuoto e babynuoto per i più piccoli.$$),
  ($$Meeting nuoto giovanile$$, '2026-07-12', '09:30', 'cuneo', $$Meeting di categoria con le società del territorio.$$),
  ($$Giornata benessere 60+$$, '2026-07-18', '16:00', 'sommariva', $$Sessioni di acquagym dolce dedicate agli over 60.$$),
  ($$Saggio fine corso$$, '2026-07-24', '18:00', 'alba', $$Saggio conclusivo dei corsi di nuoto bambini.$$),
  ($$Selezioni squadra agonistica$$, '2026-07-28', '17:30', 'cuneo', $$Selezioni per la squadra agonistica stagione 2026/27.$$);
